# src/representation/scripts/run_yamls_roberta_opt_projection_ablations.py
#
# Runs train_from_yaml sequentially on all YAMLs under:
#   <project_root>/src/representation/configs/roberta-opt/projection_ablation/*.yaml
#
# Runner stdout/stderr logs + JSONL summary are written to:
#   <project_root>/experiments/logs/run_logs/roberta_opt_projection_ablations/
#
# Usage:
#   python src/representation/scripts/run_yamls_roberta_opt_projection_ablations.py
...
def main() -> None:
    ...
    run_logs_dir = (
        ...
        / "logs"
        / "run_logs"
        / "roberta_opt_projection_ablations"
    )
    run_logs_dir.mkdir(parents=True, exist_ok=True)
    summary_path = run_logs_dir / "roberta_opt_projection_ablations.jsonl"
