# src/representation/scripts/run_yamls_baseline.py
#
# Runs train_from_yaml sequentially on all generated baseline YAMLs.
#
# YAMLs live at:
#   <repo_root>/src/representation/configs/generated/baseline_pooling/*.yaml
...
def main() -> None:
    ...
    yamls_dir = repo_root / "src" / "representation" / "configs" / "generated" / "baseline_pooling"
    ...
    summary_path = run_logs_dir / "baseline_runs.jsonl"
