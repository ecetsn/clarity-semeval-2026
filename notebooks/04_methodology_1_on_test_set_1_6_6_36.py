...
5. Generate final reports, plots, and summary tables
...
# NOTE: annotator_any_match_clarity is the new evaluation (any match is correct)
annotator_tasks = ['annotator_any_match_clarity', 'annotator1_based_clarity', 'annotator2_based_clarity', 'annotator3_based_clarity']
...
if summary_rows:
    ...
    # NOTE: annotator_any_match_clarity replaces the separate annotator1/2/3 evaluations
    desired_task_order = ['clarity', 'evasion_based_clarity', 'annotator_any_match_clarity',
