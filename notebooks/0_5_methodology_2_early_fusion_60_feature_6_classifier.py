# -*- coding: utf-8 -*-
"""0_4_early_fusion.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-zfEfxKxO1T19lNrY73lT5mNmn7Wo_0b
"""
...
print("="*80)
print("CRITICAL: This cell requires fused features from KOD HÜCRESİ 4.")
print("          If you see 'Fused features not found' errors,")
print("          please run KOD HÜCRESİ 4 first to create fused features.")

# Store all results for summary tables
all_results_type3 = {}  # {task: {classifier: {metrics, predictions, probabilities}}}

# Check if test features are available from KOD HÜCRESİ 6
if 'test_features_60' not in globals() or not test_features_60:
    print("\n❌ ERROR: test_features_60 not found!")
    print("   Please run KOD HÜCRESİ 6 first to extract test features.")
    raise RuntimeError("test_features_60 not available. Run KOD HÜCRESİ 6 first.")
...
for task in TASKS:
    ...
    if task not in test_features_60:
        print(f"  ❌ Skipping {task}: Test features not available from KOD HÜCRESİ 6")
        print(f"     Please ensure KOD HÜCRESİ 6 completed successfully for {task}.")
        continue
    ...
    # Load Train+Dev fused features (60 features) - from KOD HÜCRESİ 4
    # These were already created and saved in KOD HÜCRESİ 4
    print(f"\n  Loading fused features from KOD HÜCRESİ 4...")
    try:
        # Load fused features directly from KOD HÜCRESİ 4 (no need to reconstruct)
        ...
        print(f"\n  SOLUTION:")
        print(f"  1. Go back to KOD HÜCRESİ 4")
        print(f"  2. Run KOD HÜCRESİ 4 completely (it will create fused features)")
        print(f"  3. Wait for KOD HÜCRESİ 4 to finish successfully")
        print(f"  4. Then come back and run KOD HÜCRESİ 7 again")
        ...
        print(f"  Error: {e}")
        print(f"\n  SOLUTION:")
        print(f"  1. Check if KOD HÜCRESİ 4 completed successfully")
        print(f"  2. Verify file paths and permissions")
        print(f"  3. Try running KOD HÜCRESİ 4 again")
        print(f"\n  ⚠ Skipping {task} - cannot proceed without fused features.")
        continue
...
if all_results_type3:
    ...
    print("   1. KOD HÜCRESİ 4 completed successfully (creates fused features)")
    print("   2. KOD HÜCRESİ 6 completed successfully (creates test features)")
